...
// EXAMPLE 2
function num(num1:number, num2:number, num3:number){
    return num1+num2+num3
}
let sum = num(2,3,4)
console.log(sum);
//EXAMPLE 3 => Calculator
function calculator(x:number, y:number, operation:string){
...
function calculator1(x:number, y:number, operation:string){
    if(operation === "addition"){
        return x + y;
    }
    else if(operation === "subtraction"){
